...
{ "ER_GTID_UNSAFE_CREATE_DROP_TEMPORARY_TABLE_IN_TRANSACTION", 1787, "Statement violates GTID consistency: Under statement binary log mode CREATE TEMPORARY TABLE and DROP TEMPORARY TABLE can only be executed outside transactional context.  These statements are also not allowed in a function or trigger because functions and triggers are also considered to be multi-statement transactions." },
...
{ "ER_COMPRESSED_COLUMN_USED_AS_KEY", 3227, "Compressed column \'%-.192s\' is not allowed in the key list" },
{ "ER_UNSUPPORTED_COMPRESSED_COLUMN_TYPE", 3228, "Can not define column \'%-.192s\' in compressed format" },
{ "ER_COMPRESSION_DICTIONARY_EXISTS", 3229, "Compression dictionary \'%-.192s\' already exists" },
{ "ER_COMPRESSION_DICTIONARY_DOES_NOT_EXIST", 3230, "Compression dictionary \'%-.192s\' does not exist" },
{ "ER_COMPRESSION_DICTIONARY_NAME_TOO_LONG", 3231, "Compression dictionary name \'%-.192s\' is too long (max length = %lu)" },
{ "ER_COMPRESSION_DICTIONARY_DATA_TOO_LONG", 3232, "Data for compression dictionary \'%-.192s\' is too long (max length = %lu)" },
{ "ER_COMPRESSION_DICTIONARY_IS_REFERENCED", 3233, "Compression dictionary \'%-.192s\' is in use" },
{ "ER_CANT_EXECUTE_WITH_BACKUP_LOCK", 3234, "Can\'t execute the query because you have a conflicting backup lock" },
{ "ER_KEYS_OUT_OF_ORDER", 12000, "Keys are out order during bulk load" },
{ "ER_OVERLAPPING_KEYS", 12001, "Bulk load rows overlap existing rows" },
{ "ER_REQUIRE_ROW_BINLOG_FORMAT", 12002, "Can\'t execute updates on master with binlog_format != ROW." },
{ "ER_ISOLATION_MODE_NOT_SUPPORTED", 12003, "MyRocks supports only READ COMMITTED and REPEATABLE READ isolation levels. Please change from current isolation level %s" },
{ "ER_ON_DUPLICATE_DISABLED", 12004, "When unique checking is disabled in MyRocks, INSERT,UPDATE,LOAD statements with clauses that update or replace the key (i.e. INSERT ON DUPLICATE KEY UPDATE, REPLACE) are not allowed. Query: %s" },
{ "ER_UPDATES_WITH_CONSISTENT_SNAPSHOT", 12005, "Can\'t execute updates when you started a transaction with START TRANSACTION WITH CONSISTENT [ROCKSDB] SNAPSHOT." },
{ "ER_ROLLBACK_ONLY", 12006, "This transaction was rolled back and cannot be committed. Only supported operation is to roll it back, so all pending changes will be discarded. Please restart another transaction." },
{ "ER_ROLLBACK_TO_SAVEPOINT", 12007, "MyRocks currently does not support ROLLBACK TO SAVEPOINT if modifying rows." },
{ "ER_ISOLATION_LEVEL_WITH_CONSISTENT_SNAPSHOT", 12008, "Only REPEATABLE READ isolation level is supported for START TRANSACTION WITH CONSISTENT SNAPSHOT in RocksDB Storage Engine." },
{ "ER_UNSUPPORTED_COLLATION", 12009, "Unsupported collation on string indexed column %s.%s Use binary collation (%s)." },
{ "ER_METADATA_INCONSISTENCY", 12010, "Table \'%s\' does not exist, but metadata information exists inside MyRocks. This is a sign of data inconsistency. Please check if \'%s.frm\' exists, and try to restore it if it does not exist." },
{ "ER_KEY_CREATE_DURING_ALTER", 12011, "MyRocks failed creating new key definitions during alter." },
{ "ER_SK_POPULATE_DURING_ALTER", 12012, "MyRocks failed populating secondary key during alter." },
{ "ER_CF_DIFFERENT", 12013, "Column family (\'%s\') flag (%d) is different from an existing flag (%d). Assign a new CF flag, or do not change existing CF flag." },
{ "ER_RDB_STATUS_GENERAL", 12014, "Status error %d received from RocksDB: %s" },
{ "ER_RDB_STATUS_MSG", 12015, "%s, Status error %d received from RocksDB: %s" },
{ "ER_RDB_TTL_UNSUPPORTED", 12016, "TTL support is currently disabled when table has a hidden PK." },
{ "ER_RDB_TTL_COL_FORMAT", 12017, "TTL column (%s) in MyRocks must be an unsigned non-null 64-bit integer, exist inside the table, and have an accompanying ttl duration." },
{ "ER_RDB_TTL_DURATION_FORMAT", 12018, "TTL duration (%s) in MyRocks must be an unsigned non-null 64-bit integer." },
{ "ER_PER_INDEX_CF_DEPRECATED", 12019, "The per-index column family option has been deprecated." },
