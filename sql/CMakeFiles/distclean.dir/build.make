...
sql/CMakeFiles/distclean:
	cd /root/softm/percona-server-5.7.22-22/sql && /usr/bin/cmake -E echo WARNING: distclean target is not functional
	cd /root/softm/percona-server-5.7.22-22/sql && /usr/bin/cmake -E echo Use "'git" clean "-fdx'" instead
