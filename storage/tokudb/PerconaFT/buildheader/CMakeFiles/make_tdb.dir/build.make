...
storage/tokudb/PerconaFT/buildheader/CMakeFiles/make_tdb.dir/make_tdb.cc.o: storage/tokudb/PerconaFT/buildheader/make_tdb.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/mnt/workspace/percona-server-5.7-source-tarballs-rocks/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object storage/tokudb/PerconaFT/buildheader/CMakeFiles/make_tdb.dir/make_tdb.cc.o"
	cd /mnt/workspace/percona-server-5.7-source-tarballs-rocks/storage/tokudb/PerconaFT/buildheader && /usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/make_tdb.dir/make_tdb.cc.o -c /mnt/workspace/percona-server-5.7-source-tarballs-rocks/storage/tokudb/PerconaFT/buildheader/make_tdb.cc
...
storage/tokudb/PerconaFT/buildheader/CMakeFiles/make_tdb.dir/make_tdb.cc.i: cmake_force
	...
	cd /mnt/workspace/percona-server-5.7-source-tarballs-rocks/storage/tokudb/PerconaFT/buildheader && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /mnt/workspace/percona-server-5.7-source-tarballs-rocks/storage/tokudb/PerconaFT/buildheader/make_tdb.cc > CMakeFiles/make_tdb.dir/make_tdb.cc.i
...
storage/tokudb/PerconaFT/buildheader/CMakeFiles/make_tdb.dir/make_tdb.cc.s: cmake_force
	...
	cd /mnt/workspace/percona-server-5.7-source-tarballs-rocks/storage/tokudb/PerconaFT/buildheader && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /mnt/workspace/percona-server-5.7-source-tarballs-rocks/storage/tokudb/PerconaFT/buildheader/make_tdb.cc -o CMakeFiles/make_tdb.dir/make_tdb.cc.s
...
storage/tokudb/PerconaFT/buildheader/make_tdb: storage/tokudb/PerconaFT/buildheader/CMakeFiles/make_tdb.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/mnt/workspace/percona-server-5.7-source-tarballs-rocks/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable make_tdb"
	cd /mnt/workspace/percona-server-5.7-source-tarballs-rocks/storage/tokudb/PerconaFT/buildheader && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/make_tdb.dir/link.txt --verbose=$(VERBOSE)
...
storage/tokudb/PerconaFT/buildheader/CMakeFiles/make_tdb.dir/clean:
	cd /mnt/workspace/percona-server-5.7-source-tarballs-rocks/storage/tokudb/PerconaFT/buildheader && $(CMAKE_COMMAND) -P CMakeFiles/make_tdb.dir/cmake_clean.cmake
...
storage/tokudb/PerconaFT/buildheader/CMakeFiles/make_tdb.dir/depend:
	cd /mnt/workspace/percona-server-5.7-source-tarballs-rocks && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /mnt/workspace/percona-server-5.7-source-tarballs-rocks /mnt/workspace/percona-server-5.7-source-tarballs-rocks/storage/tokudb/PerconaFT/buildheader /mnt/workspace/percona-server-5.7-source-tarballs-rocks /mnt/workspace/percona-server-5.7-source-tarballs-rocks/storage/tokudb/PerconaFT/buildheader /mnt/workspace/percona-server-5.7-source-tarballs-rocks/storage/tokudb/PerconaFT/buildheader/CMakeFiles/make_tdb.dir/DependInfo.cmake --color=$(COLOR)
